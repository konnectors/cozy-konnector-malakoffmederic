...
describe('parse reimbursements', () => {
  ...
  it('should parse reimbursements correctly', () => {
    ...
    expect(reimbursements[0]).toEqual({
      ...
      fileurl:
        'https://extranet.malakoffmederic.com/espaceClient/sante/tbs/tbsGenererPDF.do?remb=0',
      ...
      subtype:
        'Honoraires de dispensation conditionnement normal pharmacie 65%',
      type: 'health_costs',
    ...
    expect(reimbursements[10]).toEqual({
      ...
      fileurl:
        'https://extranet.malakoffmederic.com/espaceClient/sante/tbs/tbsGenererPDF.do?remb=3',
